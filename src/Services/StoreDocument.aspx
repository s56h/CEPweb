...
<%
	...
	Try
		...
		If System.IO.File.Exists(strWebFileFolderPath) Then
			Dim intCounter = 2
			Dim strFileNameLessExt As String
			Dim StrFileExt As String
			strFileNameLessExt = System.IO.Path.GetFileNameWithoutExtension(strFileName)
			strFileExt = System.IO.Path.GetExtension(strFileName)
			strWebFileFolderPath = strWebPath & strFileNameLessExt & "2" & strFileExt
			strFileFolderPath = strFolderPath & strFileNameLessExt.Replace("'","''") & "2" & strFileExt
			While System.IO.File.Exists(strWebFileFolderPath)
				strWebFileFolderPath = strWebPath & strFileNameLessExt & intCounter.ToString() & strFileExt
				strFileFolderPath = strFolderPath & strFileNameLessExt.Replace("'","''") & intCounter.ToString() & strFileExt
