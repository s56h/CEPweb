<script language="vbscript" type="text/vbsscript" runat="server">
    ...
    '
    Public Sub PutLog(strSericeName As String, strUserType As String, strUserId As String, strTraceType As String, strProcedure As String, strMessage As String)
	'
	...
	'
		...
		strTraceString = strSericeName & "^" & strUserType & " " & strUserId & "^" & strPM & "^" & strTraceType & "^" & strProcedure & "^" & strMessage & "^" & strDate & "^" & strTime & Environment.NewLine
