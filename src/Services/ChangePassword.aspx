...
<%
    ...
    Try
        ...
        If sqlReader.HasRows Then
            ...
            Else		 '   Note: this should not occur - if it does, this could be a primitive hacking attempt
                ...
                strResultType = "Error"
				PutLog("CEP app", "Installer", strUserEmail, strResultType, "ChangePassword", strResultMsg & ". Reset keys: " & strResetKey & " " & strDbResetKey)
            End If
    ...
    Catch ex As Exception
        ...
        strResultMsg = "There was an unexpected error while changing your password (91). Please contact Carpet Cutters Commercial. "
        strResultType = "System Error"
