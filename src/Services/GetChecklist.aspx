	...
	Else
		Try
			...
			If sqlReader.HasRows Then
				...
				End While
			Else	'	The installer has no checklist
				intResultCode = 91
				strResultTitle = "Checklist problem"
				strResultMsg = "There was an error while retrieving your checklist (91). Please contact Carpet Cutters Commercial."
				strResultType = "System Error"
				PutLog("CEP app", "Installer", strUserEmail, strResultType, "GetChecklist", strResultMsg)
			End If
			sqlConn.Close()

		Catch ex As Exception	'	Some unexpected error
			intResultCode = 92
			strResultTitle = "Checklist Problem"
			strResultMsg = "There was an error while refreshing your checklist (92). Please contact Carpet Cutters Commercial."
			strResultType = "System Error"
