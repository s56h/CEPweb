  ...
  <q-page padding>
    ...
    <div class="q-gutter-y-md" style="max-width: 600px">
      <q-card>
        <div class="row">
          <div class="col-3">
            <q-btn size="md" class="full-width" color="orange-5" label="Submit"></q-btn>
          </div>
          <div class="col-7 text-center text-h6">
            Invoices
          </div>
          <div class="col-2 text-primary">
            <q-icon size="lg" name="mdi-chevron-right-box" class="q-mr-xs float-right"/>
          </div>
        </div>
        <q-separator />
        <q-list>    <!--  Invoices list  -->
          <q-item class="q-px-xs" v-for="item in installerInvoiceList" :key="item.rowId">
            ...
            <q-item-section top class="col-9 q-py-xs">
            ...
            <q-item-section class="col-2 q-py-xs">
              <!-- Note v-ifs below -->
              <div class="text-grey-8"> 
                <q-btn v-if="item.resubmit" size="12px" flat dense round icon="mdi-file-send-outline" @click="invoiceResubmit(item.rowId)" > <!--  class="q-gt-xs" -->
                  <q-tooltip class="bg-amber text-black" :offset="[10, 20]">
                    Resubmit invoice
                  </q-tooltip>
                </q-btn>
                <q-btn v-else size="12px" flat dense round icon="mdi-file-eye-outline" @click="invoiceLook(item.rowId)" > <!--  class="q-gt-xs" -->
                  <q-tooltip class="bg-amber text-black" :offset="[10, 20]">
                    Show invoice
                  </q-tooltip>
                </q-btn>
